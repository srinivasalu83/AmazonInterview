...
//https://www.glassdoor.com/Interview/Design-an-elevator-control-system-QTN_28221.htm
public class Elevator {
	...
	private Queue<Request> downQueue = new PriorityQueue<>(10, downComparator);
	...
	private void preProcessNextQueue() {
		if (getLowestTimeUpQueue() > getLowestTimeDownQueue()) {
			...
			upQueue = new PriorityQueue<>(10, upComparator);
		} else {
			this.direction = Direction.DOWN;
			currentQueue = downQueue;
			downQueue = new PriorityQueue<>(10, downComparator);
		}
	}
